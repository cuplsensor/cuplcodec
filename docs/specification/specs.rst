...
.. spec:: NDEF URL record
   ...
   **NDEF record header**
   ...
   +-----------+----------------------+----------------------+-------------------------------+----------------------+------------+
   | Desc      | :need:`CODEC_SPEC_5` | :need:`CODEC_FEAT_7` | :need:`CODEC_FEAT_5`          | :need:`CODEC_FEAT_8` | URL Prefix |
   +-----------+----------------------+----------------------+-------+-------+-------+-------+----------------------+------------+
   | Byte      | 0                    | 1                    | 2     | 3     | 4     | 5     | 6                    | 7          |
   +-----------+----------------------+----------------------+-------+-------+-------+-------+----------------------+------------+
   | Data      |                      | 0x01                 | PL[3] | PL[2] | PL[1] | PL[0] | 0x55                 | 0x03       |
   +-----------+----------------------+----------------------+-------+-------+-------+-------+----------------------+------------+

    **NDEF record payload start**

   +-----------+------+------+------+-------------------+-------------+
   | Desc.     | `Base URL`_        |  `Time interval`_ | `Serial`_   |
   +-----------+------+------+------+-------------------+-------------+
   | Data      | t.plotsensor.com   |  /?t=AWg*         | &s=YWJjZGVm |
   +-----------+------+------+------+-------------------+-------------+

   **NDEF record payload continued**

   +-----------+-------------+-------------+--------------------+
   | Desc.     | `Version`_  | `Status`_   | CircBufferStart    |
   +-----------+-------------+-------------+--------------------+
   | Data      | &v=01       | &x=AAABALEK | &q=                |
   +-----------+-------------+-------------+--------------------+
