...
#define BATV_RESETCAUSE(BATV, RSTC) ((BATV << 8) | (RSTC & 0xFF)) /*!< Macro for creating a 16-bit batv_resetcause value from 8-bit \verbatim :need:`CODEC_FEAT_30` \endverbatim and \verbatim :need:`CODEC_SPEC_16` \endverbatim values. */
